...
export PYTHONPATH=$PYTHONPATH:/home/abon/source
...
alias vi=nvim
setxkbmap fr
export PATH=$PATH:/home/linuxbrew/.linuxbrew/bin:/usr/local/cuda-8.0/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin:$HOME/bin
